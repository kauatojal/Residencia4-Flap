    ...
    <div className="kanban-wrapper">
      ...
      <aside className={`kanban-sidebar ${menuOpen ? 'sidebar-open' : ''}`}>
        ...
        <nav className="sidebar-main-menu">
          <button onClick={() => handleMenuClick(onSwitchDashboard)} className="sidebar-btn">
            Dashboard
          </button>
          <button onClick={() => handleMenuClick(onSwitchKanban)} className="sidebar-btn">
            Kanban
          </button>

          <button onClick={() => handleMenuClick(onSwitchUsuarios)} className="sidebar-btn">
            Usuários
          </button>
          <button onClick={() => handleMenuClick(onSwitchClientes)} className="sidebar-btn">
            Clientes
          </button>
          <button onClick={() => handleMenuClick(onSwitchConfiguracoes)} className="sidebar-btn">
            Arquivados
          </button>
          ...
          <button onClick={() => handleMenuClick(onLogout)} className="sidebar-btn">
            Sair
          </button>
        </nav>
