  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (cliente && cliente.id) {
        ...
        console.log("Modo EDIÇÃO - ID:", cliente.id);
      ...
      if (error.response?.status === 403) {
        ...
        msg = 'Conflito (409). Este email já está cadastrado.';
        ...
        <div className="cadastro-cliente-container">
          ...
          <form className="cadastro-cliente-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <div className="logo-upload-container" style={{opacity: 0.5, pointerEvents: 'none'}}>
                <div className="logo-upload-box">
                  <div className="logo-placeholder">
                    <span>⚠️ Funcionalidade em desenvolvimento no backend</span>
                  </div>
                </div>
              </div>
            </div>
